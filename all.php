...
<tr>
	...
	<td><a href="index.php?p=artikel&m=edit&id=<?php echo $key['id'];?>">mengubah</a></td>
	<td><a onclick="return confirm('Hapus Data <?php echo $key['judul'];?>')"href="proses/artikel/hapus.php?id=<?php echo $key['id'];?>">Hapus</a></td>
</tr>
<?php
	$i++;
}
